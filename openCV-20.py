...
cv2.createTrackbar('Hue Low','myTracker',160,180,onTrack1)
cv2.createTrackbar('Hue High','myTracker',180,180,onTrack2)
 
cv2.createTrackbar('Hue Low2','myTracker',0,180,onTrack7)
cv2.createTrackbar('Hue High2','myTracker',10,180,onTrack8)
 
cv2.createTrackbar('Sat Low','myTracker',100,255,onTrack3)
cv2.createTrackbar('Sat High','myTracker',200,255,onTrack4)
